...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hp_customer: Schema.Attribute.String;
    jam: Schema.Attribute.Enumeration<
      [
        'jam_10_00',
        'jam_11_00',
        'jam_12_00',
    ...
    >;
    kapster: Schema.Attribute.Relation<'oneToOne', 'api::kapster.kapster'>;
    ...
    > &
      Schema.Attribute.Private;
    nama_customer: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiKapsterKapster extends Struct.CollectionTypeSchema {
...
export interface ApiLayananLayanan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    harga: Schema.Attribute.BigInteger;
    kethar: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::layanan.layanan'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::kapster.kapster': ApiKapsterKapster;
